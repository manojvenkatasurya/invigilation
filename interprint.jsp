...
<jsp:scriptlet>
	rs=(ResultSet)session.getAttribute("printrs");
	if(rs!=null)
	{
</jsp:scriptlet>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/backGround.jpeg');background-attachment:fixed;">
			<div class="wrap-login100 p-t-30 p-b-50" style="width:650px;">
				<form class="login100-form validate-form p-b-33 p-t-5" action="interprint" method="post" target="_blank">
					...
					<option value=<%=rs.getString("exam_name")%>><jsp:expression>rs.getString("exam_name")</jsp:expression></option>
					<jsp:scriptlet>
						}
					</jsp:scriptlet>
					</select>
